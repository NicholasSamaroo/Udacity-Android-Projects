...
public class QueryUtils {
    ...
    /**
     * Return a list of {@link QuakeObject} objects that has been built up from
     * parsing a JSON response.
     */
    public static ArrayList<QuakeObject> extractEarthquakes() {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<QuakeObject> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            for (int i = 0; i < featuresArray.length(); i++) {
                ...
                earthquakes.add(new QuakeObject(magnitude, location, unixTime, URL));
            }
